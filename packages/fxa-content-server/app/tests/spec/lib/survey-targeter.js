...
describe('lib/survey-targeter', () => {
  ...
  it('returns a survey if the view matches', async () => {
    ...
    assert.equal(
      ...
      'https://www.surveygizmo.com/s3/5541940/pizza?browser=Firefox&service=content&env=production'
    );
  });
  ...
  it('generates the survey URL with matching conditions, env, and service as query parameters', async () => {
    ...
    const expectedUrl =
      'https://www.surveygizmo.com/s3/5541940/pizza?languages=en-CA%2Cfr-CA&browser=Firefox&os=Mac%20OS&service=content&env=production';
    assert(
